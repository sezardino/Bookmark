...
const Header = () => {
	const [activeNav, toggleNavHandler] = useActive();
	const isNavActive = activeNav ? 'header--active' : '';
	return (
		<header className={`header ${isNavActive}`}>
			<div className="container header__container">
				<div className="header__wrapper">
					<Link to="/" className="logo header__logo">
						<span className="hidden">To Home Page</span>
						<svg
							className="logo"
							...
							<g fill="none" fillRule="evenodd">
								...
								/>
								<g>
									<circle className="logo--circle" fill="#5267DF" cx="12.5" cy="12.5" r="12.5" />
									<path
					...
					<button type="button" className="button header__close" onClick={() => toggleNavHandler()}>
